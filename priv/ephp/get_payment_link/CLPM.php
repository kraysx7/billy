<?php
  ...
  // Берём базовый URL, на который подключена данная система и перенаправляем на checkout форму
  $payment_link = $paysystem_config["conn_url"]."/payment/cloudpayments/checkout?tr_id=".$billy_transaction_id."&signature=".$signature;
